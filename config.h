...
static const char *fonts[]          = { "JetBrains:size=10" };
static const char dmenufont[]       = "JetBrains:size=10";
...
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { s_base2,   s_base03,  s_base02},
	[SchemeSel]  = { s_base2,   s_base02,  s_base02},
};
